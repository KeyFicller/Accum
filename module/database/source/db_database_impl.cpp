...
global_handle_helper&
database_impl::helper()
{
    static global_handle_helper helper_inst;
    return helper_inst;
}
bool
database_impl::add_object(db_object* _object, db_object_id& _id)
{
    bool ret = true;
...
bool
database_impl::remove_object(const db_object_id& _id)
{
    bool ret = true;
...
db_object*
database_impl::get_object(db_handle _handle) const
{
