...
filer&
filer_impl::write_bytes(const void* _value, int _bytes)
{
...
filer&
filer_impl::read_bytes(void* _value, int _bytes)
{
...
void
filer_impl::flush_in(filer& _other, int _bytes)
{
...
void
filer_impl::flush_out(filer& _other, int _bytes)
{
    ASSERT(index() + _bytes <= last_index());
