...
void
log::trace(const std::string& _message)
{
    return IMPL(log)->trace(_message.c_str());
}
void
log::info(const std::string& _message)
{
    return IMPL(log)->info(_message.c_str());
}
void
log::warn(const std::string& _message)
{
    return IMPL(log)->warn(_message.c_str());
}
void
log::error(const std::string& _message)
{
    return IMPL(log)->error(_message.c_str());
}
void
log::critical(const std::string& _message)
{
