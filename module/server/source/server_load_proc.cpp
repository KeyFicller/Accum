...
void
load_proc::begin_sequence()
{
    return IMPL(load_proc)->begin_sequence();
}

void
load_proc::end_sequence()
{
...
void
load_proc::out(std::string& _value)
{
    return IMPL(load_proc)->out(_value);
}

void
load_proc::out(const std::string& _value)
{
    return IMPL(load_proc)->out(_value);
}

void
load_proc::out(int& _value)
{
    return IMPL(load_proc)->out(_value);
}

void
load_proc::out(float& _value)
{
    return IMPL(load_proc)->out(_value);
}

void
load_proc::out(bool& _value)
{
    return IMPL(load_proc)->out(_value);
}

bool
load_proc::has_value() const
{
    return IMPL(load_proc)->has_value();
}

bool
load_proc::has_key(const std::string& _value) const
{
