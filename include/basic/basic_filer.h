...
namespace PRJ_NAME
{
    ...
    struct filer_serializer
    {
        ...
        static void dump(filer &_filer, const t &_value)
        {
            _filer.write_bytes(&_value, sizeof(t));
        }

        static void load(filer &_filer, t &_value)
        {
            _filer.read_bytes(&_value, sizeof(t));
        }
    };

    template <typename t>
    filer &operator<<(filer& _filer, const t &_value)
    {
    ...
    template <typename t>
    filer &operator>>(filer& _filer, t &_value)
    {
    ...
    {
        static void dump(filer& _filer, const char* _value)
        {
