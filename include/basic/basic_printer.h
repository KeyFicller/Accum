...
namespace PRJ_NAME
{
    ...
    template <>
    inline std::string print<const char *>(const char *const &_value)
    {
        return _value;
    }

    template <>
    inline std::string print<char *>(char *const &_value)
    {
        return _value;
    }

    template <>
    inline std::string print<nullptr_t>(const nullptr_t &_value)
    {
        return "0x0";
    }
    ...
    inline std::string format_print(const std::string &_format, args &&..._args)
    {
    ...
    template <typename... args>
    inline std::string format_print(const prompt_id &_prompt_id, args &&..._args)
    {
    ...
    template <unsigned n>
    inline void format_print_impl(std::string &_buffer)
    {
        return;
    }

    template <unsigned n, typename arg, typename... args>
    inline void format_print_impl(std::string &_buffer, arg &&_arg, args &&..._args)
    {
